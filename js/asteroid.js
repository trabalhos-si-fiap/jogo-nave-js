export class Rock {
  constructor(x = 0, y = 0, id=0, height = 20, width = 20, image = null, speed = 10) {
    this.id = id;
    this.x = x;
    this.y = y;
    this.height = height;
  ...
  calcYtragetory(randInt) {
    if (!this.seatedTrajectory) {
        ...
        if ( middleToDown ) {
            ...
            // console.log('metade para baixo - Mover para baixo', this.y);
        } else if (middleUp) {
            this.yDirection = randInt(0, 5);
            // console.log('metade para cima - Mover para cima', this.y);
        }
